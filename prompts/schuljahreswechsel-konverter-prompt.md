...
Erweitere den Konverter (`konverter/GSH_Terminplan_Konverter.html`) um einen
...
Die Vorlage `GSH_Terminplan_Schulwochen_Vorlage.xlsx` hat folgende Struktur:
...
Dropzone zum Hochladen der aktuellen `GSH_Terminplan_Schulwochen_Vorlage.xlsx`.
...
4. Speichert als `GSH_Terminplan_Schulwochen_Vorlage_YYYY_YY.xlsx` via
...
- `konverter/GSH_Terminplan_Konverter.html` – hier wird alles implementiert
- `website/downloads/GSH_Terminplan_Schulwochen_Vorlage.xlsx` – Beispiel-Upload zum Testen
