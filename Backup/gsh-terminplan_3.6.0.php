...
function gsh_tp_settings_page() {
    ...
    if ( isset( $_POST['gsh_tp_save_profile'] ) ) {
        if ( wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['gsh_tp_sp_n'] ?? '' ) ), 'gsh_tp_profile_save' ) ) {
            ...
            if ( ! $url_check['valid'] && ! empty( $raw_data['ical_url'] ) ) {
                echo '<div class="notice notice-warning"><p>&#9888; Profil gespeichert, aber die iCal-URL ist ung&uuml;ltig: <strong>'
    ...
    if ( isset( $_POST['gsh_tp_save_categories'] ) ) {
        if ( wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['gsh_tp_cats_n'] ?? '' ) ), 'gsh_tp_categories_save' ) ) {
            ...
            echo '<div class="notice notice-success"><p>&#10003; Kategorien gespeichert.</p></div>';
        } else {
            echo '<div class="notice notice-error"><p>Sicherheitspr&uuml;fung fehlgeschlagen.</p></div>';
        }
    }
    ...
    if ( isset( $_POST['gsh_tp_clear_logs'] ) ) {
        if ( wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['gsh_tp_cl_n'] ?? '' ) ), 'gsh_tp_clear_logs' ) ) {
            ...
            echo '<div class="notice notice-success"><p>&#10003; ' . (int) $removed
                ...
                <td>
                    ...
                    (function(){
                        ...
                        inp.addEventListener('input', function(){
                            ...
                            fb.innerHTML = '<span style="color:#888">&#8987; Wird gepr&uuml;ft\u2026</span>';
                            timer = setTimeout(function(){
                                if(val.indexOf('https://') !== 0){
                                    fb.innerHTML = '<span style="color:#991b1b">&#10005; Nur HTTPS erlaubt</span>';
                                    return;
                                }
                                try{
                                    var u = new URL(val);
                                    ...
                                    if(!u.hostname || u.hostname.indexOf('.') === -1){
                                        fb.innerHTML = '<span style="color:#991b1b">&#10005; Ungültige URL-Syntax (kein gültiger Hostname)</span>';
                                        return;
                                    }
                                    fb.innerHTML = '<span style="color:#166534">&#10003; URL-Syntax g&uuml;ltig &ndash; wird beim Speichern server-seitig gepr&uuml;ft</span>';
                                }catch(e){
                                    fb.innerHTML = '<span style="color:#991b1b">&#10005; Ung&uuml;ltige URL-Syntax</span>';
                                }
                            }, 1000);
                        });
                    })();
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    if ( empty( $cur_token ) ) {
                        echo '<p style="color:#c0392b;margin-top:6px"><strong>&#9888; Kein Token gesetzt</strong> &ndash; '
                           . 'die Kiosk-Seite ist ohne Authentifizierung erreichbar!</p>';
                    } elseif ( strlen( $cur_token ) < 20 ) {
                        echo '<p style="color:#e67e22;margin-top:6px"><strong>&#9888; Token zu kurz</strong> &ndash; '
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if ( empty( get_option( 'gsh_tp_iserv_domain', '' ) ) ) : ?>
                        <p style="color:#e67e22;margin-top:6px"><strong>&#9888; IServ-Domain fehlt</strong> &ndash;
...
function gsh_tp_render_sync_log_tab() {
    ...
    <form method="post" style="display:inline-block">
        ...
        <button type="submit" name="gsh_tp_clear_logs" value="1" class="button"
            ...
            &#128465; Logs &auml;lter als 30 Tage l&ouml;schen
        </button>
        <span class="description" style="margin-left:10px">
