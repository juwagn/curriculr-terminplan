...
| Datei | Änderung |
|-------|----------|
| `konverter/Terminplan_Konverter.html` | Zeilen 1252 + 1322: endDate für "Ganze Woche" mit ISO-Datum in Spalte G |
...
**Files:**
- Modify: `konverter/Terminplan_Konverter.html:1252` (neues Format)
- Modify: `konverter/Terminplan_Konverter.html:1322` (altes Format)
...
Datei: `konverter/Terminplan_Konverter.html`
...
4. Excel-Vorlage `website/downloads/Terminplan_Schulwochen_Vorlage.xlsx` anhängen
5. Claude ausführen lassen → `Terminplan_2026_27.xlsx` herunterladen
