...
Erwartete Ausgabe:
```
Lade: ...Terminplan_Schulwochen_Vorlage.xlsx
  SW 00: Zeile 2
  SW 41: Zeile 658
  max_row: 673
Gespeichert: ...
...
python -c "
import openpyxl
wb = openpyxl.load_workbook('website/downloads/Terminplan_Schulwochen_Vorlage.xlsx')
ws = wb['Terminplan']
...
- Excel-Vorlage: `website/downloads/Terminplan_Schulwochen_Vorlage.xlsx`
````
...
**Files:**
- Output: `website/downloads/Terminplan_Schulwochen_Vorlage.xlsx`
...
`website/downloads/Terminplan_Schulwochen_Vorlage.xlsx` öffnen:
...
```bash
git add website/downloads/Terminplan_Schulwochen_Vorlage.xlsx
