...
| Output | `website/downloads/Terminplan_Schulwochen_Vorlage.xlsx` (via Skript) |
...
Excel-Datei `website/downloads/Terminplan_Schulwochen_Vorlage.xlsx` öffnen.
...
```bash
git add scripts/build_excel_template.py website/downloads/Terminplan_Schulwochen_Vorlage.xlsx
