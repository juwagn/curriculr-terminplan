...
**Datum:** 2026-03-23
**Dateien:** `konverter/Terminplan_Konverter.html`, `scripts/build_excel_template.py`, `prompts/excel-import-prompt.md`, `scripts/patch_2026_27.py` (einmalig)
...
### Problem 5 – Bestehende Datei Terminplan_2026_27.xlsx ist defekt
...
6. Backup: Originaldatei nach `vorlagen/Terminplan_2026_27.xlsx.bak` kopieren vor dem Überschreiben
7. Speichern als `vorlagen/Terminplan_2026_27.xlsx`
