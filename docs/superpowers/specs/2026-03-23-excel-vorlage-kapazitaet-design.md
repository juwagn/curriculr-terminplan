...
**Ablauf:**
1. xlsx laden (`website/downloads/GSH_Terminplan_Schulwochen_Vorlage.xlsx`)
...
| Regeneriert durch Scripts | `website/downloads/GSH_Terminplan_Schulwochen_Vorlage.xlsx` |
